...
namespace eBookStore.Areas.Admin.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        //will be used upload document or etc.
        ...
        public IActionResult Upsert(ProductVM productVM)
        {
            if (ModelState.IsValid)
            {
                ...
                if(files.Count > 0)
                {
                    ...
                    using(var filesStreams = new FileStream(Path.Combine(uploads,fileName+extensions),FileMode.Create))
                    {
                ...
                {
                    //update when the do not chane the image
